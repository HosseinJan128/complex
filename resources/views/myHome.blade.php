...
@section('jscontent')
    ...
    <script src="{!! asset('hj/js/myhome.js') !!}"></script>
@endsection
@section('csscontent')
    ...
    <div class="row clearfix">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="info-box bg-cyan hover-expand-effect">
                ...
                <div class="content">
                    <div class="text">Msisdn Exist</div>
